...
namespace OpenUtau.Core.Pipeline {
    ...
    public sealed class PhonemeSource {
        ...
        // HiFiUTAU / Custom Server note-level options (fork).
        ...
        internal PhonemeSource(UPhoneme phoneme, int noteIndex, TimeAxis axis,
            ...
            // HiFiUTAU / Custom Server note-level options (fork). An absent
            // descriptor means "off" (0), as in the pre-snapshot RenderPhone.
